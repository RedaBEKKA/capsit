    ...
    return (
      ...
      >
        ...
        <div
          ...
          <div style={{textAlign: "center", fontWeight: "normal", fontSize:10,color: '#484444',marginTop:10}}>Cette adresse mail sera utilisée pour<br/> vous connecter à votre espace.</div>
          <form className={classes.root} noValidate autoComplete="on" style={{margin:30,display: "flex",alignItems: "center",justifyContent: "center",flexDirection:"column"}}>
            ...
            <div className="register-text" style={{textAlign: "center",fontSize: "10px",margin: "10px 10px 5px 10px",color: '#484444'}}>
                En cliquant sur <span style={{color: "black",fontWeight:'normal'}}>« S’inscrire »</span> , vous acceptez les <Link to="" style={{color: "#26B965"}}> conditions générales d’utilisation</Link> 
                et <Link to="" style={{color: "#26B965"}}>politique de confidentialité</Link><br/><br/>Vous pouvez vous désinscrire à tout moment en faisant
                <br/>la demande dans la page profil ou à travers les liens
                de désinscription présents dans nos mails.
            </div>
