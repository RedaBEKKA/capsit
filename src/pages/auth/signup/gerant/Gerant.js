...
const Gerant = () => {
  const [fromGerant,setFromGerant] = useState(true)

  const navigate =useNavigate()
  const handleClick = () => {
    setFromGerant(true)
    navigate(`/privateLayout/`,{state:fromGerant})
  }
    ...
    return (
      ...
      >
        ...
        <div
          ...
          <div style={{textAlign: "center", fontWeight: "bold",fontSize: 16,color: '#484444',marginTop:10}}>Vous êtes un utilisateur Gerant</div>
